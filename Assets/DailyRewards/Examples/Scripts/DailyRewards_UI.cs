...
namespace NiobiumStudios
{
    ...
    public class DailyRewards_UI : MonoBehaviour
    {
      ...
      //  private Color colorUnclaimed;       // The Color of the background when not claimed
        ...
        public Image ImageClaim;            // The Color of the background when claimed
        private Image ImageUnclaimed;       // The Color of the background when not claimed
